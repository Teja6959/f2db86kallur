...
router.get('/', function (req, res) { 
    res.render('index', { title: 'football App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'football App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'football App Login', user : req.user }); 
}); 
